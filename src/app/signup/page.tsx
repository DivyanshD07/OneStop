        ...
        <div className="flex flex-col w-3/5 justify-center items-center p-5 hoveranimationsignin">
          ...
          <div className="flex flex-col gap-2 justify-center items-center p-1">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div>
                <input type="password" id="password" name="password" placeholder='password' required className={`bg-dark-grey border-b border-gray-200 focus:outline-none focus:border-blue-600 w-full px-4 py-2 text-black ${!passwordValid && 'border-red-500'}`} onChange={handleChange} />
